...
namespace Todo.Application.Services
{
    ...
    {
        ValueTask<Task> CreateTaskAsync(Task task, CancellationToken cancellationToken = default);
        ...
        ValueTask<Task> UpdateTaskAsync(Task task, int id, CancellationToken cancellationToken = default);
